...
<div class="container">
    ...
    <spring:url value="/admin/employees/list" var="employeeActionUrl" />

    <form:form class="form-horizontal" method="post" modelAttribute="employeeForm" action="${employeeActionUrl}" enctype="multipart/form-data"> <%--enctype="multipart/form-data"--%>
        ...
        <spring:bind path="info">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <label class="col-sm-2 control-label">Инфо</label>
                <div class="col-sm-10">
                    <form:textarea path="info" rows="5" class="form-control" id="info" placeholder="info" />
                </div>
            </div>
        </spring:bind>
        ...
        <spring:bind path="content">
                ...
                <div class="col-sm-10">
                   <%-- <form:input path="content" type="file" name="file" id="file" class="form-control" placeholder="Photo" />--%>
